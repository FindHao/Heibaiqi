...
public class ChatInnerFrame extends JInternalFrame {
	/**
	 * @author Find 内部聊天窗口
	 */
	...
	public ChatInnerFrame(String aname1, String bname1) {
		super();
		this.aname = aname1;
		this.bname = bname1;
		setClosable(false);
...
//		chatmap.setPreferredSize(new Dimension(getContentPane().getWidth(),
//				getContentPane().getHeight() - 80));
		textpanel.setPreferredSize(new Dimension(400,
				100));
